...
module.exports.run = async (bot, message, args, guild) => {
    ...
    const tavsiyeKanal = bot.channels.find('id', '747391297123385375'); //kanal id girin
    ...
    message.channel.sendEmbed(new Discord.RichEmbed().setColor("GREEN").setDescription('Tavsiyeniz başarıyla [destek sunucumuza](https://discord.gg/gec2SeP) gönderildi! ✅'));
})};
